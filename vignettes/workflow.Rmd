...
```{r}
#input_dir <- file.path("~/Documents/index_hopping/data/hiseq4000/input")
input_dir<- dirname(tempfile_prefix)
```
```{r}
...
Alternatively you can run all the preceding 4 steps all at once
